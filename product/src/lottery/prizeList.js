...
function showPrizeList(currentPrizeIndex) {
  ...
  let htmlCode = `<div class="prize-mess"><label class="prize-shine-b">正在抽取</label><label id="prizeType" class="prize-shine">${currentPrize.text}</label><label id="prizeText" class="prize-shine">${currentPrize.title}</label><label class="prize-shine-b">剩余</label><label id="prizeLeft" class="prize-shine">${currentPrize.count}</label><label class="prize-shine-b">个</label></div><ul class="prize-list">`;
  prizes.forEach(item => {
